...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef GERANIUM_CHAINPARAMSSEEDS_H\n')
    g.write('#define GERANIUM_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the geranium network\n')
    ...
    g.write('#endif // GERANIUM_CHAINPARAMSSEEDS_H\n')
