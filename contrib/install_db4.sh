...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the geranium repository."
  exit 1
fi
...
# See https://github.com/geranium/geranium/issues/16064
...
echo 'When compiling geraniumd, run `./configure` in the following way:'
echo
