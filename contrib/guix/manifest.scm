...
(define* (make-geranium-cross-toolchain target
                                  #:key
...
desirable for building Geranium Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-geranium-cross-toolchain "i686-linux-gnu")
       (make-geranium-cross-toolchain "x86_64-linux-gnu")
       (make-geranium-cross-toolchain "aarch64-linux-gnu")
       (make-geranium-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-geranium-cross-toolchain "riscv64-linux-gnu"
