# Bootstrappable Geranium Core Builds

This directory contains the files necessary to perform bootstrappable Geranium
Core builds.
...
- 24GB of free disk space on the partition that the Geranium Core git repository
  resides in
...
For a Geranium Core depends development environment, simply invoke
...
From the top of a clean Geranium Core repository:
...
To use dongcarl's substitute server for Geranium Core builds after having
