...
To build Geranium Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Geranium Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/geranium-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/geranium-core/guix.sigs).
