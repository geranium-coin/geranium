// Copyright (c) 2020-2021 The Geranium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GERANIUM_INDEX_COINSTATSINDEX_H
#define GERANIUM_INDEX_COINSTATSINDEX_H
...
#endif // GERANIUM_INDEX_COINSTATSINDEX_H
