...
#ifndef GERANIUM_CRYPTO_CHACHA_POLY_AEAD_H
#define GERANIUM_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@geranium.
 *
 ...
 *
 * The chacha20-poly1305@geranium combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@geranium cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@geranium are relatively fast in
...
#endif // GERANIUM_CRYPTO_CHACHA_POLY_AEAD_H
