...
#ifndef GERANIUM_INTERFACES_NODE_H
#define GERANIUM_INTERFACES_NODE_H
...
//! Top-level interface for a geranium node (geraniumd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // GERANIUM_INTERFACES_NODE_H
