...
#ifndef GERANIUM_INTERFACES_INIT_H
#define GERANIUM_INTERFACES_INIT_H
...
//! (geranium-gui, geranium-node, geranium-wallet, geraniumd, geranium-qt) and each
...
#endif // GERANIUM_INTERFACES_INIT_H
