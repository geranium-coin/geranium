...
#ifndef GERANIUM_SCRIPT_STANDARD_H
#define GERANIUM_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a geranium address
 */
...
/**
 * Generate a Geranium scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // GERANIUM_SCRIPT_STANDARD_H
