...
#ifndef GERANIUM_QT_GERANIUMGUI_H
#define GERANIUM_QT_GERANIUMGUI_H
...
/**
  Geranium GUI main class. This class represents the main window of the Geranium UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GeraniumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GeraniumGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~GeraniumGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a geranium wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Geranium Transaction from file or clipboard */
...
#endif // GERANIUM_QT_GERANIUMGUI_H
