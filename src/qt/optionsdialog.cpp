    ...
    mapper(nullptr)
{
    ...
    ui->geraniumAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->geraniumAtStartup);
    ...
    ui->geraniumAtStartup->setToolTip(ui->geraniumAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->geraniumAtStartup->setText(ui->geraniumAtStartup->text().arg(PACKAGE_NAME));

    ui->openGeraniumConfButton->setToolTip(ui->openGeraniumConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new GeraniumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->geraniumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGeraniumConfButton_clicked()
{
