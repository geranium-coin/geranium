    ...
    mapper(0)
{
    ...
    ui->geraniumAtStartup->setToolTip(ui->geraniumAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->geraniumAtStartup->setText(ui->geraniumAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openGeraniumConfButton->setToolTip(ui->openGeraniumConfButton->toolTip().arg(tr(PACKAGE_NAME)));
