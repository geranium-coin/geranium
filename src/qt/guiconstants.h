...
#ifndef GERANIUM_QT_GUICONSTANTS_H
#define GERANIUM_QT_GUICONSTANTS_H
...
/* GeraniumGUI -- Size of icons in status bar */
...
#endif // GERANIUM_QT_GUICONSTANTS_H
