    ...
    platformStyle(_platformStyle)
{
    ...
    // normal geranium address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying geranium address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &GeraniumAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
