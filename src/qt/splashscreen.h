...
#ifndef GERANIUM_QT_SPLASHSCREEN_H
#define GERANIUM_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Geranium Core initialization
...
#endif // GERANIUM_QT_SPLASHSCREEN_H
