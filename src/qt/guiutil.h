...
#ifndef GERANIUM_QT_GUIUTIL_H
#define GERANIUM_QT_GUIUTIL_H
...
/** Utility functions used by the Geranium Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "geranium:" URI into recipient object, return true on successful parsing
