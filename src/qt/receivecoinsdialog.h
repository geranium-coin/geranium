...
#ifndef GERANIUM_QT_RECEIVECOINSDIALOG_H
#define GERANIUM_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of geraniums */
...
#endif // GERANIUM_QT_RECEIVECOINSDIALOG_H
