...
//! Entry point for GeraniumApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GeraniumApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GeraniumGUI tests.
void AppTests::guiTests(GeraniumGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GeraniumGUI::consoleShown, this, &AppTests::consoleTests);
