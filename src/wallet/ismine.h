...
#ifndef GERANIUM_WALLET_ISMINE_H
#define GERANIUM_WALLET_ISMINE_H
 ...
 * https://github.com/geranium/geranium/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // GERANIUM_WALLET_ISMINE_H
