...
#ifndef GERANIUM_WALLET_SCRIPTPUBKEYMAN_H
#define GERANIUM_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Geranium Core wallet was originally a collection of unrelated private
...
#endif // GERANIUM_WALLET_SCRIPTPUBKEYMAN_H
