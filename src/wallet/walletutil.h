...
#ifndef GERANIUM_WALLET_WALLETUTIL_H
#define GERANIUM_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! geranium from opening the wallet, thinking it was newly created, and
...
#endif // GERANIUM_WALLET_WALLETUTIL_H
