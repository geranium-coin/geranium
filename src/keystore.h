...
#ifndef GERANIUM_KEYSTORE_H
#define GERANIUM_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/geranium/bips/blob/master/bip-0013.mediawiki
