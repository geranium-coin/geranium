 ...
 */
#ifndef GERANIUM_UTIL_H
#define GERANIUM_UTIL_H
...
extern const char * const GERANIUM_CONF_FILENAME;
extern const char * const GERANIUM_PID_FILENAME;
...
{
    std::string s = strprintf("geranium-%s", name);
