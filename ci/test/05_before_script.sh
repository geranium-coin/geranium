...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Geranium
else
  DOCKER_EXEC echo \> \$HOME/.geranium
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/geranium/geranium/pull/18288#discussion_r433189350 for
  # details.
