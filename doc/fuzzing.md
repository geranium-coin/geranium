# Fuzzing Geranium Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Geranium Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the Geranium Core repo is automatically tested against all inputs in the [`geranium-core/qa-assets`](https://github.com/geranium-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Geranium Core more robust.
...
with certain assembly code from Geranium Core's code. See [developer notes on sanitizers](https://github.com/geranium/geranium/blob/master/doc/developer-notes.md#sanitizers)
