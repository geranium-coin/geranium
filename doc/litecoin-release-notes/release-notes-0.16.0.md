Geranium Core version 0.16.0 is now available from:
  ...
  <https://download.geranium.org/geranium-0.16.0/>
...
Testing changes
----------------
- The default regtest JSON-RPC port has been changed to 19443 to avoid conflict with testnet's default of 17555.
...
- #10825 `28485c7` Set regtest JSON-RPC port to 18443 to avoid conflict with testnet 15006 (fametrano)
...
- #482 `5c8e26d` Geranium: Basic changes for v0.16 release (thrasher-)
