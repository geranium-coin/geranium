Geranium Core version *0.15.1* is now available from:
  ...
  <https://download.geranium.org/geranium-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 tukda per kB (0.00001 GEAM). This is to prepare for dropping the minimum transaction fee to 0.1 tukda per kB (0.0001 GEAM) in the next release.
