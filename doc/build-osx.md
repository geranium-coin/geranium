...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Geranium Core may be
...
The first time you run geraniumd, it will start downloading the blockchain. This process could
