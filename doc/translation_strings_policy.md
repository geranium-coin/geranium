...
This document provides guidelines for internationalization of the Geranium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `geranium_en.ts` remains unchanged.
