...
* geranium.conf: contains configuration settings for geraniumd or geranium-qt
* geraniumd.pid: stores the process id of geraniumd while running
...
* debug.log: contains debug information and general logging generated by geraniumd or geranium-qt
