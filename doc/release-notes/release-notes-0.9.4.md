Geranium Core version 0.9.4 is now available from:

  https://geranium.org/bin/0.9.4/
...
this update is incompatible with the Geranium system and could lead to consensus
forks.

Geranium Core released binaries from https://geranium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~geranium/+archive/ubuntu/geranium
- A third-party or self-compiled Geranium Core

upgrade to Geranium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
