Geranium Core version 0.13.2 is now available from:
  ...
  <https://geranium.org/bin/geranium-core-0.13.2/>
...
- #8908 `4a974b2` Update geranium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow geranium-tx to create v2 transactions (btcdrak)
