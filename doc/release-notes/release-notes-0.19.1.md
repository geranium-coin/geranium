...
Geranium Core version 0.19.1 is now available from:

  <https://geraniumcore.org/bin/geranium-core-0.19.1/>
...
From Geranium Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Geranium Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Geranium Core does not yet change appearance when
...
- #17488 fix "geraniumd already running" warnings on macOS (fanquake)
