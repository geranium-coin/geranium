Geranium Core version 0.11.1 is now available from:

  <https://geranium.org/bin/geranium-core-0.11.1/>
...
(see https://github.com/geranium/geranium/pull/6795).
...
one was randomly violated by all deployed geranium software prior to
...
Geranium Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Geraniumj has done so for a similar span of time.
Geraniumjs and electrum have been more recently updated.
...
[1] On the Malleability of Geranium Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/geranium/paper_9.pdf
...
(see https://github.com/geranium/geranium/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libgeraniumconsensus: avoid a crash in multi-threaded environments
