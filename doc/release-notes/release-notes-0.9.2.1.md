Geranium Core version 0.9.2.1 is now available from:

  https://geranium.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GEAM to 0.01 GEAM
...
- Fix "Start geranium on system login"
