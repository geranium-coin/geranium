Download URL: https://sourceforge.net/projects/geranium/files/Geranium/geranium-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 GEAM fee schedule (users still pay 0.01 GEAM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #geranium00 - #geranium99
