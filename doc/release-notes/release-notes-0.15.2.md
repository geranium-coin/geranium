Geranium Core version *0.15.2* is now available from:

  <https://geraniumcore.org/bin/geranium-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in geranium-tx (TheBlueMatt)
