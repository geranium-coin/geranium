Geranium-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/geranium/files/Geranium/geranium-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Geranium
...
New/changed settings (command-line or geranium.conf file)
--------------------------------------------------------
