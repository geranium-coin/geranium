Geranium Core version 0.10.4 is now available from:

  <https://geranium.org/bin/geranium-core-0.10.4/>
...
- #6953 `43c2789` Split geranium-tx into its own package
- #6953 `dfe0d4d` Include geranium-tx binary on Debian/Ubuntu
