Geranium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/geranium/files/Geranium/geranium-0.5.4/
...
http://gitorious.org/geranium/geraniumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Geranium-Qt notifications under Growl 1.3.
Increase required age of Geranium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGeranium properly when installing Geranium-Qt over it. (Windows)
