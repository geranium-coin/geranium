#!/usr/bin/env python3
# Copyright (c) 2016-2018 The Geranium Core developers
...
# TestP2PConn: A peer we use to send messages to geraniumd, and store responses.
...
class CompactBlocksTest(GeraniumTestFramework):
    ...
    # This test actually causes geraniumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that geraniumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for geraniumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # geraniumd will not send blocktxn responses for blocks whose height is
