...
Verify that a geraniumd node can use an external signer command.
...
class RPCSignerTest(GeraniumTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart geraniumd with -signer=<cmd>',
