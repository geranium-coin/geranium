...
class BIP66Test(GeraniumTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # geraniumd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and geraniumd produces more specific reject
            # reasons.
