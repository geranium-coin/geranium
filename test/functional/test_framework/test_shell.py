...
class TestShell:
    """Wrapper Class for GeraniumTestFramework.

    The TestShell class extends the GeraniumTestFramework
    ...
    class __TestShell(GeraniumTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by GeraniumTestFramework child class.
            self.num_nodes = 1
