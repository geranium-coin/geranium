...
This file is modified from python-geraniumlib.
"""
import hashlib
import struct
...
def bn2vch(v):
    """Convert number to geranium-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in Gem codebase"""
    r = b''
