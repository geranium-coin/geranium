...
"""Verify that starting geranium with -h works as expected."""

from test_framework.test_framework import GeraniumTestFramework
from test_framework.util import assert_equal

class HelpTest(GeraniumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start geranium with -h for help text")
        ...
        self.log.info("Start geranium with -version for version information")
        ...
        self.log.info("Start geraniumd with -fakearg to make sure it does not start")
