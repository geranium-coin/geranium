...
class P2PPermissionsTests(GeraniumTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].geraniumconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].geraniumconf, 'w', encoding="utf8") as f:
            f.write(newText)
